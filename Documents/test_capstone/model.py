...
Original file is located at
    https://colab.research.google.com/drive/1NOfOXfRu7zMGL6aDJcaHQPJTFDRyoS0Q
"""
...
def recommend(job_name, cosine_sim = cosine_sim):
    ...
    return recommended_jobs_.to_json()

recommend('You will get High quality Character design')

import marshal, ujson as json

x = json.dumps(recommended_jobs)

y = json.loads(x)
print(y)

pickle.dump(recommended_jobs, open('model.pkl','wb'))
